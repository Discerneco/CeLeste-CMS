...
3. **[airtable-nextjs-integration.md](./airtable-nextjs-integration.md)** - Guide for integrating Airtable with Next.js
...
6. Follow the [integration guide](./airtable-nextjs-integration.md) to connect your Next.js app to Airtable
